      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        ...
        <div class="collapse" id="collapseExample" style="background-color: #707070;">
          <div class="card card-body" style="background-color: rgb(112, 112, 112); color:white;">
            <ul id="nav-list">
              <li><a href="blog">Psi</a></li>
              <li><a>Macke</a></li>
              <li><a>Ostali kucni ljubmci</a></li>
              <li><a>U pricu sa</a></li>
              <li><a>Nesvrstani</a></li>
            </ul>
          </div>
        </div>
          <li class="nav-item" id="about-nav">
            <p style="margin-top: 1rem;">Aboout us</p>
          </li>
          <li class="nav-item">
                ...
                <div class="right-side">
                    <div class="slideshow-container" id="slideshow-container" >
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="site-images/Pet-Zoona-Macke.jpg" style="width:100%">
                          
                        </div>
                        
                        <div class="mySlides fade">
                           
                            <img src="site-images/Pet-Zoona-Psi-2.jpg" style="width:100%">
                            
                          </div>
                         <div class="mySlides fade">
                          
                            <img src="site-images/Pet-Zoona-Psi-3.jpg" style="width:100%">
                           
                          </div> 
                          <div class="mySlides fade">
                          
                            <img src="site-images/Pet-Zoona-Psi-4.jpg" style="width:100%">
                           
                          </div>
                          <div class="mySlides fade">
                          
                            <img src="site-images/Pet-Zoona-Psi.jpg" style="width:100%">
                           
                          </div>
                          <div class="mySlides fade">
                            
                            <img src="site-images/Pet-Zoona-Zmije-Podgorica-4.jpg" style="width:100%">
                            ...
                            <div class="contact-main">
                              ...
                              <div class="contact-right">
                                <div class="contact-form">
                                  ...
                                  <button id="send"><p>Posalji</p></button>
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="dog-section" id="dog-section" style="display: none;">
                          <div class="dog-left">
                          ...
                          <div class="dog-right">
                            <div class="dog-categories">
                              <ul>
                                <li>Psi Kategorija 1</li>
                                <li>Psi Kategorija 2</li>
                                <li>Psi Kategorija 3</li>
                                <li>Psi Kategorija 4</li>
                                <li>Psi Kategorija 5</li>
                              </ul>
                            </div>
